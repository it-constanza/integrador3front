...
const Contacto = () => {
  return (
    <>
      ...
      <h3> Dejanos tus dudas, tu metodo preferido de contacto y un especialista se pondra en contacto con vos.</h3>
        ...
        <form className="ctcform" action="#" method="post">
          ...
          <div className="form__fieldset">
            <fieldset>
              ...
              <div className="form__inputlabel">
                <label htmlFor="ctc" className="form__label block">¿Como preferis que te contactemos?:</label>
                <select name="ctc" id="ctc" className="form__input block">
              ...
              <div className="form__inputlabel block">
                <label htmlFor="contanos" className="form__label block" >Contanos en que podemos ayudarte. </label>
                <textarea name="contanos" id="contanos" cols="45" rows="5" className="form__input block" placeholder="Cuanto mas informacion nos des, mas interesante sera la informacion que te prepare nuestro especialista" ></textarea>
          ...
          <div className="novedades block"> <input type="checkbox" id="Novedades" name="Novedades" value="Novedades" defaultChecked className="form__cbox" />
